...
<head>
  ...
  ?>
  <title>Makaroni bang zaad— <?php echo htmlspecialchars($name) ?></title>
</head>
<body>
...
<div class="container" style="margin-top: 50px;">
  ...
  <a class="magnifier-thumb-wrapper demo">
    <img id="thumb" 
         src="product_images/<?php echo htmlspecialchars($image); ?>" 
         style="width: 100%; height: auto; object-fit: contain; border: 1px solid #ccc;" 
         alt="Foto Produk">
  </a>
</div>
          <div class="col s8">
